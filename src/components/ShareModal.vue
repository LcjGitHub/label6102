      ...
      <div v-if="visible" class="share-modal" @click="handleOverlayClick">
        <div class="share-modal__content card" @click="handleContentClick">
          ...
          <div class="share-modal__options">
            <button type="button" class="share-modal__option" @click="copyLink">
            ...
            >
              ...
              <svg
                class="share-modal__chevron"
                :class="{ 'share-modal__chevron--up': wechatExpanded }"
                viewBox="0 0 24 24"
                fill="none"
                stroke="currentColor"
                stroke-width="2"
            ...
            <button type="button" class="share-modal__option" @click="openWeibo">
          ...
          <div class="share-modal__footer">
            <button type="button" class="btn share-modal__cancel" @click="emit('close')">
              取消
            </button>
          </div>
        </div>
