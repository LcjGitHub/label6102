...
const filteredPoints = computed(() => {
  ...
  return points.filter((p) => selectedTags.value.every((tag) => p.tags.includes(tag)))
})
...
<template>
  <div class="home">
    <div v-if="deleteSuccessVisible" class="toast toast--success">
      ...
      <button type="button" class="toast__close" aria-label="关闭" @click="closeDeleteSuccess">
        <svg
          viewBox="0 0 24 24"
          fill="none"
          stroke="currentColor"
    ...
    <aside class="home__sidebar card">
      ...
      <TagFilter :tags="allTags" :selected="selectedTags" @toggle="toggleTag" @clear="clearTags" />
